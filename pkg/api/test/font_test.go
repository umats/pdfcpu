...
func writeCoreFontDemoContent(c context.Context, xRefTable *model.XRefTable, p model.Page, fontName string) error {
...
func createCoreFontDemoPage(c context.Context, xRefTable *model.XRefTable, w, h int, fontName string) (model.Page, error) {
	mediaBox := types.RectForDim(float64(w), float64(h))
	p := model.NewPageWithBg(mediaBox, color.NewSimpleColor(0xbeded9))
	if err := writeCoreFontDemoContent(c, xRefTable, p, fontName); err != nil {
